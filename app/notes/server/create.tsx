...
function SubmitButton() {
    ...
    return(
        ...
        className="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300 cursor-pointer disabled:bg-gray-400">
        Submit
        </button>
    )
}
...
export default function CreateForm() {
    ...
    return (
        <div className="mx-auto p-6 bg-white shadow-lg rounded-lg sticky top-0">
